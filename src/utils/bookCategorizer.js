...
const GENRE_KEYWORDS = {
  romance: {
    keywords: [
      'romance', 'romántico', 'romántica', 'love story', 'historia de amor',
      'passion', 'pasión', 'kiss', 'beso', 'wedding', 'boda', 'marriage', 'matrimonio',
      'relationship', 'relación', 'couple', 'pareja', 'dating', 'citas',
      'valentine', 'san valentín', 'heartbreak', 'desamor', 'affair', 'aventura'
    ],
    mood: 'light'
  },
  mystery: {
    keywords: [
      'mystery', 'misterio', 'murder', 'asesinato', 'crime', 'crimen',
      'detective', 'detective', 'investigation', 'investigación', 'clue', 'pista',
      'suspense', 'suspenso', 'secret', 'secreto', 'conspiracy', 'conspiración',
      'whodunit', 'enigma', 'puzzle', 'rompecabezas', 'mysterious', 'misterioso'
    ],
    mood: 'dark'
  },
  'sci-fi': {
    keywords: [
      'sci-fi', 'science fiction', 'ciencia ficción', 'space', 'espacio', 'future', 'futuro',
      'robot', 'robot', 'alien', 'alienígena', 'technology', 'tecnología',
      'galaxy', 'galaxia', 'planet', 'planeta', 'time travel', 'viaje temporal',
      'cyberpunk', 'dystopia', 'distopía', 'apocalypse', 'apocalipsis',
      'spaceship', 'nave espacial', 'artificial intelligence', 'inteligencia artificial'
    ],
    mood: 'reflective'
  },
  fantasy: {
    keywords: [
      'fantasy', 'fantasía', 'magic', 'magia', 'dragon', 'dragón',
      'wizard', 'hechicero', 'witch', 'bruja', 'fairy', 'hada',
      'kingdom', 'reino', 'castle', 'castillo', 'sword', 'espada',
      'quest', 'búsqueda', 'adventure', 'aventura', 'mythology', 'mitología',
      'hobbit', 'elf', 'elfo', 'dwarf', 'enano', 'orc', 'orco',
      'middle-earth', 'tierra media', 'tolkien', 'magical', 'mágico'
    ],
    mood: 'fun'
  },
  thriller: {
    keywords: [
      'thriller', 'suspense', 'suspenso', 'horror', 'terror', 'fear', 'miedo',
      'scary', 'aterrador', 'nightmare', 'pesadilla', 'ghost', 'fantasma',
      'haunted', 'embrujado', 'supernatural', 'sobrenatural', 'paranormal',
      'psychological', 'psicológico', 'tension', 'tensión', 'danger', 'peligro'
    ],
    mood: 'dark'
  },
  fiction: {
    keywords: [
      'novel', 'novela', 'story', 'historia', 'tale', 'cuento',
      'narrative', 'narrativa', 'literature', 'literatura', 'classic', 'clásico',
      'contemporary', 'contemporáneo', 'drama', 'drama', 'family', 'familia',
      'coming of age', 'madurez', 'life', 'vida', 'human', 'humano'
    ],
    mood: 'reflective'
  }
};
...
const MOOD_KEYWORDS = {
  light: [
    'happy', 'feliz', 'joy', 'alegría', 'fun', 'divertido', 'comedy', 'comedia',
    'humor', 'humor', 'cheerful', 'alegre', 'bright', 'brillante', 'sunny', 'soleado'
  ],
  reflective: [
    'deep', 'profundo', 'thoughtful', 'reflexivo', 'philosophical', 'filosófico',
    'contemplative', 'contemplativo', 'meditative', 'meditativo', 'introspective', 'introspectivo'
  ],
  dark: [
    'dark', 'oscuro', 'sad', 'triste', 'melancholy', 'melancolía', 'gloomy', 'sombrío',
    'depressing', 'deprimente', 'tragic', 'trágico', 'bleak', 'desolador'
  ],
  fun: [
    'funny', 'gracioso', 'hilarious', 'divertidísimo', 'entertaining', 'entretenido',
    'amusing', 'divertido', 'witty', 'ingenioso', 'playful', 'juguetón'
  ]
};
...
// Palabras clave específicas para libros conocidos
...
const determineGenre = (text) => {
  // Primero buscar coincidencias específicas de libros conocidos
  ...
  // Requerir al menos 2 coincidencias para géneros específicos (excepto fiction)
...
const determineMood = (text, genreMood) => {
  // Buscar palabras clave específicas de mood
  ...
  // Si no encuentra palabras específicas, usar el mood del género
  return genreMood;
};
...
export const categorizeBook = (book) => {
  try {
    ...
    // Combinar y normalizar texto
    const combinedText = combineBookText(book);
    
    // Si no hay texto, usar valores por defecto
    if (!combinedText) {
      return DEFAULT_CATEGORIZATION;
    }
